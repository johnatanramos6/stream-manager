-- =====================================================================
-- PARCHE DE ACTUALIZACIÓN: Corrección de tipo para purchase_date en la compra
...
BEGIN
  ...
  SELECT balance, status, name INTO v_reseller_balance, v_reseller_status, v_reseller_email_name
  ...
  -- Corrección: CURRENT_DATE se pasa directamente (tipo date) en vez de CURRENT_DATE::TEXT (tipo text)
  INSERT INTO public.subscriptions (
    ...
    p_manager_id, v_catalog_platform, v_selected_email, v_selected_password, p_reseller_name || ' (Tienda)', '',
