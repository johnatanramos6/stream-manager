-- =====================================================================
-- PARCHE DE ACTUALIZACIÓN V5: Corrección de Zona Horaria (Colombia) en Compras Automáticas
...
BEGIN
  ...
  -- Usamos la fecha y hora de Colombia local (América/Bogotá) para evitar desfase de UTC tras las 7 PM.
  INSERT INTO public.subscriptions (
    ...
    (CURRENT_TIMESTAMP AT TIME ZONE 'America/Bogota')::date, v_profile_pin, 'pagado', 'Compra automática - Revendedor: ' || v_reseller_email_name,
  ...
  v_credentials := jsonb_build_object(
    ...
    'notes', v_order_notes,
    'purchase_date', ((CURRENT_TIMESTAMP AT TIME ZONE 'America/Bogota')::date)::TEXT,
